...
const Nav = () => {
  return (
    <>
      <>
        <nav className="fixed top-0 z-40 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 max-md:hidden">
          ...
          <div className="h-full px-0 pb-4 overflow-y-auto bg-[#DF5532] text-[#EEFFEEFE]">
            ...
            <ul className="space-y-2 pt-20 font-[400] text-sm font-roboto">
              <li className="h-[37px]">
                <Link
                  to="/"
                  className="flex items-center px-5 p-2 rounded-lg dark:text-white hover:bg-gradient-to-r from-[#FFAD98] to-[#DF5532] dark:hover:bg-gray-700 group text-[#EEFFEEFE]"
                >
                  <svg
                    width="18"
                    height="18"
